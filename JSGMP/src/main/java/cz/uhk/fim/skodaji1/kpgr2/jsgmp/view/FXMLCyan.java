 ...
 */
public class FXMLCyan extends FXMLController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        {
            FXMLCyan.this.imageViewHistogram.setFitWidth(FXMLCyan.this.vBoxContent.getWidth() - 10);
        });
