...
import static cz.uhk.fim.skodaji1.kpgr2.zbuffer.model.PrimitiveType.BICUBICS;
import static cz.uhk.fim.skodaji1.kpgr2.zbuffer.model.PrimitiveType.LINE;
import static cz.uhk.fim.skodaji1.kpgr2.zbuffer.model.PrimitiveType.TRIANGLE;
...
{    
    ...
    default public String getEnumValue(String enumName)
    {
        ...
        {
            reti = this.getFill().getEnumValue(enumName);
        }
        return reti;
    }
    ...
    {
        if (property.toLowerCase().trim().equals("typ") == false)
        {
    ...
    default public String[] getAllowedValues(String enumName)
    {
        ...
        if (enumName.toLowerCase().trim().equals("typ"))
        {
            ...
            reti = new String[]{"Trojúhelník", "Bikubika", "Úsečka"};
        }
        else
        {
            reti = this.getFill().getAllowedValues(enumName);
        }
        return reti;
    }
